      ...
      <div className="flex-1 flex flex-col justify-center px-6 relative z-10">
        ...
        >
          ...
          <form onSubmit={handleSignup} className="flex flex-col gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3.5 rounded-2xl bg-secondary border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-neon-green/50 focus:border-neon-green/50 transition-all"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3.5 rounded-2xl bg-secondary border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-neon-green/50 focus:border-neon-green/50 transition-all pr-12"
            ...
            <motion.button
              ...
              disabled={loading}
              whileTap={{ scale: 0.97 }}
              className="w-full py-4 rounded-2xl bg-neon-green text-accent-foreground font-semibold text-base mt-2 neon-glow-green disabled:opacity-50 transition-all active:scale-95"
            >
          ...
          <p className="text-center text-sm text-muted-foreground mt-8">
            ...
            <Link to="/login" className="text-neon-green font-medium">
              Sign in
            </Link>
          </p>
        </motion.div>
